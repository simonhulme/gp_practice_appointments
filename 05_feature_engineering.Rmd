...
gp_appts_attended_objects <- 
    list(
        data = 
            list(data_prepared_full_tbl = data_prepared_full_tbl,
                 train_test_tbl         = train_test_tbl,
                 train_tbl              = train_tbl, 
                 test_tbl               = test_tbl,
...
write_rds(gp_appts_attended_objects, "00_data/processed/gp_appts_attended_objects.rds")
```
